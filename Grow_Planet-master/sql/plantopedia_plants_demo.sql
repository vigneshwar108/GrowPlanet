...
--
-- Table structure for table `plants_demo`
--

DROP TABLE IF EXISTS `plants_demo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `plants_demo` (
